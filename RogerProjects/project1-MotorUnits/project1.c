...
double time;
{
 ...
 //  targetTheta = roger->base_setpoint[THETA];
   thetaerror  = roger->base_setpoint[THETA] - roger->base_position[THETA];
//   printf("Thetaerror: %lf\n Roger_setpointTHETA: %lf\n Roger_basepositionTHETA: %lf\n" , thetaerror, roger->base_setpoint[THETA]);
 //   printf("Thetaerror: %lf\n" , thetaerror);
